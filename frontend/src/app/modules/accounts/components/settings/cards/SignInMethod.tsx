...
import {updateUserPassword} from '../../../../../../_metronic/partials/widgets/tables/redux/usersAction'
...
const SignInMethod: React.FC = () => {
  ...
  const formik2 = useFormik<IUpdatePassword>({
    ...
    onSubmit: (values) => {
      setLoading2(true)
      dispatch(updateUserPassword(values.newPassword))
    },
    validationSchema: passwordFormValidationSchema,
  })

  return (
    <div className='card mb-5 mb-xl-10' style={{display: 'none'}}>
      <div
