...
const ChatPage: React.FC = () => {
  return (
    <Switch>
      <Route path='/apps/chat/private-chat/:userId'>
        <PageTitle breadcrumbs={chatBreadCrumbs}>Support</PageTitle>
        <Private />
      </Route>
      ...
      <Route path='/apps/chat/chat'>
        <PageTitle breadcrumbs={chatBreadCrumbs}>Chat api</PageTitle>
      </Route>
