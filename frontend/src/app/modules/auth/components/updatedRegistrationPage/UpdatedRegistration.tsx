...
export default function UpdatedRegistration() {
  const [passwordType, setPasswordType] = useState('password');
  const [passwordIconClass, setPasswordIconClass] = useState('fa-eye');
  const [confirmPasswordType, setConfirmPasswordType] = useState('password');
  const [confirmPasswordIconClass, setConfirmPasswordIconClass] = useState('fa-eye');
    ...
    const toggleConfirmPasswordVisibility = () => {
      ...
      setConfirmPasswordIconClass(prevClass => prevClass === 'fa-eye-slash' ? 'fa-eye' : 'fa-eye-slash');
    };
    const initialValues = {
        userName: '',
        firstName: '',
...
// }
  ...
  return (
    ...
    <div className="midClickContainer">
        <h3 className="midContain_Heading">Werde Jetzt Creator</h3>
        <div className="midContainerWraping">
            <h4 className="midContain_registerHeading">Registriere dich als creator in unseren communities</h4>
            <div className="midContain_inputFields">
                ...
                <label htmlFor="firstName">
                    <p>Vorname:</p>
                    {/* <input className="registerInputField" type="text" placeholder='Vorname' /> */}
                    <input
            placeholder='Vorname'
            type='text'
      ...
      <div className='errorMessageWrapper'>
        <span role='alert'>{formik.errors.firstName}</span>
                ...
                <label htmlFor="lastName">
                    <p>Nachname:</p>
                    {/* <input className="registerInputField" type="text" placeholder='Nachname' /> */}
                    <input
            ...
            <div className="errorMessageWrapper">
                ...
                <label htmlFor="userName">
                    <p>Benutzername:</p>
                    {/* <input className="registerInputField" type="text" placeholder='Benutzername (Vor und Nachname)' /> */}
                    <input
      ...
      />
      <i className={`fa-solid ${confirmPasswordIconClass} passwordVisible`} onClick={toggleConfirmPasswordVisibility}></i>
    </label>
...
<div className='termsAndConditionsCheckBox'>
          ...
          {formik.touched.acceptTerms && formik.errors.acceptTerms && !formik.values.acceptTerms &&(
