...
let AdminGateway = class AdminGateway {
    ...
    afterInit(server) {
        console.log(...oo_oo(`73b5b92d_0`, 'Initialized'));
    }
    ...
    async onMultiMessage(client, data) {
        console.log(...oo_oo(`73b5b92d_1`, data));
